...
const UpdownPatient: React.FC<{ isAuthenticated: boolean }> = ({ isAuthenticated }) => {
  const packageName = "panel.dehkade.ir";
  ...
  const handleDelete = (fileName: string, versionName: string) => {
    const requestData = {
      fileName,
      versionName,
      appPackageName: "panel.dehkade.ir",
      filePath: "",
    };
